...
export default function CardRare(props) {
  ...
  return (
      <div className="cards p-2 max-w-[348px] w-full">
          {isPending && <Loading/>}
          <div className="flex justify-center rare rounded-[20px]">
          <img src={props.image} className="max-w-[242px] w-full h-auto py-[24px] px-[46px]" alt="card rare"/>
          </div>
